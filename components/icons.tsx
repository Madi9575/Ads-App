...
// Using SVG components for icons to ensure perfect alignment and consistent rendering.

// --- ICONS (Lucide Style) ---

// Sidebar & Core Navigation Icons
...
export const AdCreatorIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M5 12h14" />
        <path d="M12 5v14" />
    </svg>
);
export const CampaignsIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const CompetitorsIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const TemplateIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const CursorClickIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m9 9 5 12 1.8-5.2L21 14Z" />
        <path d="M7.2 2.2 8 5.1" />
        <path d="m5.1 8-2.9-.8" />
        <path d="M14 4.1 12 6" />
        <path d="m6 12-1.9-1.9" />
    </svg>
);
...
export const EuroIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M4 10h12" />
        <path d="M4 14h12" />
        <path d="M19 6a7.7 7.7 0 0 0-5.2-2A7.9 7.9 0 0 0 6 12c0 4.4 3.5 8 7.8 8 2.5 0 4.8-.9 6.2-2.7" />
    </svg>
);
...
export const BuildingOffice2Icon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M9 18v-5.46a3.78 3.78 0 0 1 .48-1.8L11 8" />
        <path d="M15 18v-5.46a3.78 3.78 0 0 0-.48-1.8L13 8" />
        <path d="M12 18V8" />
...
export const HandThumbUpIcon = ({ className = "w-6 h-6" }: { className?: string; }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M7 10v12" />
        <path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2h0a3.13 3.13 0 0 1 3 3.88Z" />
    </svg>
);
export const ChatBubbleOvalLeftEllipsisIcon = ({ className = "w-6 h-6" }: { className?: string; }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ArrowSmallLeftIcon = ({ className = "w-6 h-6" }: { className?: string; }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <line x1="19" y1="12" x2="5" y2="12" />
        <polyline points="12 19 5 12 12 5" />
    </svg>
...
export const PlayIconFilled = ({ className = "w-6 h-6" }: { className?: string; }) => (
...
export const LineChartIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M3 3v18h18" />
...
export const CrownIcon = ({ className = 'w-4 h-4' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M5.25 14.25L4.5 6.75L9 9.75L12 3.75L15 9.75L20.25 6.75L19.5 14.25H5.25ZM19.5 15.75V17.25H5.25V15.75H19.5Z" />
    </svg>
);


// --- BRAND ICONS (Retained as SVGs) ---

export const FacebookIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="#1877F2">
...
export const TikTokIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 448 512" fill="currentColor">
        <path d="M448 209.9a210.1 210.1 0 0 1-122.8-39.25V349.4a162.6 162.6 0 1 1-162.6-162.6V278.2a74.6 74.6 0 1 0 52.2 71.18V0l88 0a121.2 121.2 0 0 0 1.86 22.17h0A122.2 122.2 0 0 0 381 102.4a121.4 121.4 0 0 0 67 20.14z"/>
    </svg>
);
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24">
        <defs>
            <radialGradient id="instagram-gradient" cx="0.3" cy="1" r="1">
                ...
                <stop offset="0.5" stopColor="#FD8D32"/>
                <stop offset="1" stopColor="#F5333F"/>
            </radialGradient>
            <linearGradient id="instagram-gradient-2" x1="1" y1="0" x2="0" y2="1">
                <stop offset="0" stopColor="#F5333F"/>
                <stop offset="0.2" stopColor="#E03C51"/>
                <stop offset="0.4" stopColor="#C74673"/>
                <stop offset="0.6" stopColor="#A8529B"/>
                <stop offset="1" stopColor="#515BD4"/>
            </linearGradient>
        </defs>
        <path fill="url(#instagram-gradient-2)" d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.584-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.07-1.645-.07-4.85s.012-3.584.07-4.85c.149-3.225 1.664-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163zm0 1.44c-3.116 0-3.483.011-4.691.068-2.61.12-3.633 1.15-3.753 3.753-.056 1.208-.067 1.575-.067 4.691s.011 3.483.067 4.691c.12 2.603 1.143 3.633 3.753 3.753 1.208.056 1.575.067 4.691.067s3.483-.011 4.691-.067c2.61-.12 3.633-1.15 3.753-3.753.056-1.208.067-1.575.067-4.691s-.011-3.483-.067-4.691c-.12-2.603-1.143-3.633-3.753-3.753C15.483 3.614 15.116 3.603 12 3.603z"/>
        <path fill="url(#instagram-gradient-2)" d="M12 6.865A5.135 5.135 0 1017.135 12 5.135 5.135 0 0012 6.865zm0 8.56A3.425 3.425 0 1115.425 12 3.425 3.425 0 0112 15.425z"/>
        <path fill="url(#instagram-gradient-2)" d="M16.949 6.833a1.2 1.2 0 10-1.199-1.2 1.2 1.2 0 001.199 1.2z"/>
    </svg>
);

export const LinkedInIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="#0077B5">
